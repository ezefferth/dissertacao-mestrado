...
% FIGURAS PENDENTES: telas do aplicativo (login, dashboard de eventos em tempo real,
% lista de pacientes, gestão de dispositivos, notificação de alerta). Capturar do app Expo
% em execução e salvar em assets/.
